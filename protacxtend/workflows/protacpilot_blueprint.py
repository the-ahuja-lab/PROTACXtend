...
PROTACpILOT_BLUEPRINT: List[Dict[str, Any]] = [
    ...
    {"stage": "ternary", "node": "ternary_generator",
     "desc": "Ternary complex generation — COMPASS / PRosettaC / PROTAC-Model.",
     "kind": "node", "engine": None, "external": ["COMPASS", "PRosettaC", "PROTAC-Model"],
     "evidence": "STRUCTURAL SURROGATE"},
